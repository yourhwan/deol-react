// src/pages/ChartNewTrackPage.jsx
...
const ChartNewTrackPage = () => {
    ...
    // ★ 신곡 TOP(발매 30일 이내 + 최근 7일 재생)
    const fetchChartTracks = async () => {
        try {
            const res = await axios.get(
                '/api/chart/new-releases',
                { params: { limit: 100, releaseDays: 30, lookbackDays: 7 } }
            );
            console.log('[new-top api]', res.status, res.data);
    ...
    const fetchUserPlaylists = async () => {
        try {
            ...
            if (!token) return; // 비로그인도 페이지는 보이므로 조용히 패스
            ...
            <div className="playlist-detail-page">
                <div className="playlist-detail-header">
                    ...
                    <div className="playlist-detail-info">
                        <h1>신곡 TOP 100</h1>
                        <p>최근 <b>30일 이내 발매</b>된 곡 중,<br />최근 <b>7일 재생 수</b> 기준 집계</p>
                            ...
                            return (
                                <li key={key} className="playlist-track-item">
                                    <div className="track-col track-info">
                                        ...
                                        <img src={track.coverImage || defaultCover} alt="cover" className="track-cover" />
...
export default ChartNewTrackPage;
